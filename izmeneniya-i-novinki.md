...
* Разработана поддержка **Deep Linking** / Внешнего связывания:  
  * Deep Links для чат-виджета.
...
* Доработки интерфейса: 
  * Лог выполнения очереди триггеров.
  * Ручное удаление заданий из очереди вебхуков.
  * Очередь триггеров/скриптов: доступ к отмене через интерфейс
* Несколько интеграций **NLP**: раздел Лиды / Активная NLP интеграция - выводить, если используется NLP.
* Раздел **Лиды** доработка фильтров. 
  * доработка фильтров.
  * доработка экспорта.
