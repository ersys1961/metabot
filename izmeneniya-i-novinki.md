...
* Оптимизация: Очередь вебхуков. Равномерное распределение задач по воркерам
...
* Доработки по **Livetex:** команды оператора "/bot" и "/operator" - выполнение скриптов с типом _Возврат_ и _Перевод на оператора_
