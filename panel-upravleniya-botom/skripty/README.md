...
{% hint style="info" %}
Рекомендуем также ознакомиться с подробным описанием [Разделы скриптов](https://metarex.gitbook.io/metabot24/panel-upravleniya-botom/skripty/razdely-skriptov).
{% endhint %}
