...
1. если хотим искать частичное вхождение указанного кода среди sender.url, то не указываем начало и конец строки в регулярке, т.е. записываем просто строку metabotbot
